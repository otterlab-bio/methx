...
- Rust 1.75+
- A system HDF5 runtime is not required for release binaries; source builds require CMake and a C compiler for static HDF5 compilation.
- For download functionality: network access

...
- **Source builds:** Rust/Cargo, CMake, a C compiler, and the native build tools required by `hdf5-metno`.
- **Release binaries:** no system HDF5 runtime is required because HDF5 is statically linked.
